...
const HistoryHero = () => {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: `url('/placeholder-history.jpg')` }}
    >
      ...
      >
        <h1 className="text-5xl md:text-6xl font-bold font-serif leading-tight">L'Histoire des Petits Pâtés Nîmois</h1>
      </motion.div>
    </section>
  );
};
